				...
				<table class="table table-condensed table-responsive table-no-border">
					<tbody>
						...
						<tr>
							...
							<td><span class="f-11 label-table black label-inherit upper-case">EMAIL: <span class="text-transform-reset">{{$s->email}}</span></span></td>
							<td><span class="f-11 label-table black label-inherit upper-case padding-bottom-unset"><span class="upper-case">LCL - Local</span></span></td>
						</tr>
						<tr>
							...
							<td><span class="f-11 label-table black label-inherit upper-case padding-bottom-unset"><span class="upper-case">FOR - Foreign</span></span></td>
						</tr>
					</tbody>
				</table>
