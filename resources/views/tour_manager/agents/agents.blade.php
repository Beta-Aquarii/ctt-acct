		...
		<div class="col-xs-12 col-sm-12 col-md-3">
			<div class="btn-group btn-group-justified" role="group" aria-label="...">
			  	<div class="btn-group" role="group">
			    	<a href="{{url('admin/add/agent')}}" class="btn btn-lg btn-blue-3"><i class="fa fa-plus"></i> Agent</a>
			  	</div>
			  	<div class="btn-group" role="group">
					...
					<div class="panel panel-default">
					  	<div class="panel-heading text-center bg-green">
					  		...
					  		<div class="btn-group float-right gear-position">
								...
								<ul class="dropdown-menu">
									<li class="text-center"><a href="{{url('admin/edit/agent').'/'.$a->id}}" class="text-bold br-edit"><i class="fa fa-pencil-square-o blue"></i> Edit</a></li>
								    <li role="separator" class="divider"></li>
								    <li class="text-center"><a href="#" class="text-bold br-add-contact" data-title="{{$a->name}}" data-agent="{{$a->id}}"><i class="fa fa-plus green"></i> Contact</a></li>
								    <li role="separator" class="divider"></li>
								    <li class="text-center"><a href="#" class="text-bold br-delete deleteThisAgent" data-act="{{$a->id}}" data-var="agents" data-name="{{$a->name}}"><i class="fa fa-close red"></i> Delete</a></li>
								</ul>
							</div>
					  	</div>
	  	...
	  	<div class="modal-dialog" role="document">
		    <div class="modal-content">
			    ...
			    <div class="modal-footer bg-green">
			        <div class="btn-group btn-group-justified" role="group" aria-label="...">
					  	<div class="btn-group" role="group">
					    	<button type="button" class="btn btn-lg btn-red close-modal" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
					  	</div>
					  	<div class="btn-group" role="group">
							<button type="button" class="btn btn-lg btn-dark-2"><i class="fa fa-plus"></i> Commit</button>
					  	</div>
					</div>
			    </div>
		    </div>
